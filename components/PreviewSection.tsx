...
const PreviewSection: React.FC<PreviewProps> = ({ data, totals, skills }) => {
  ...
  return (
    <div id="printable-quotation" className="bg-white rounded-xl shadow-lg overflow-hidden max-w-[900px] mx-auto text-[#333] printable-area">
      ...
      {/* HEADER */}
      <div className="bg-[#ffd75b] p-6 flex justify-between items-start">
        <div>
      ...
      <div className="p-7 border-b border-gray-100">
        <h3 className="font-bold text-sm uppercase mb-3 tracking-wide text-gray-800 border-l-4 border-[#ffd75b] pl-2">Client Information</h3>
      ...
      {/* EVENTS */}
      <div className="p-7 border-b border-gray-100">
        <h3 className="font-bold text-sm uppercase mb-4 tracking-wide text-gray-800 border-l-4 border-[#ffd75b] pl-2">Event Coverage Breakdown</h3>
        
        {data.events.map((event, index) => (
          <div key={event.id} className="mb-4 bg-gray-50 rounded-lg p-4 border border-gray-200 text-sm break-inside-avoid">
      ...
      <div className="p-7 border-b border-gray-100 break-inside-avoid">
        <h3 className="font-bold text-sm uppercase mb-3 tracking-wide text-gray-800 border-l-4 border-[#ffd75b] pl-2">Package Summary</h3>
        
        <div className="bg-[#fff8dc] border border-[#f1d48a] rounded-lg p-4 text-sm">
      ...
      {/* DELIVERABLES */}
      <div className="p-7 border-b border-gray-100 break-inside-avoid">
        <h3 className="font-bold text-sm uppercase mb-3 tracking-wide text-gray-800 border-l-4 border-[#ffd75b] pl-2">Final Deliverables</h3>
        <div className="bg-gray-50 border-l-4 border-gray-300 p-3 rounded-r-md text-sm text-gray-700">
      ...
      {data.addOns.length > 0 && (
        <div className="p-7 border-b border-gray-100 break-inside-avoid">
            <h3 className="font-bold text-sm uppercase mb-3 tracking-wide text-gray-800 border-l-4 border-[#ffd75b] pl-2">Optional Add-ons</h3>
      ...
      {/* PAYMENT & LOGISTICS */}
      <div className="p-7 border-b border-gray-100 break-inside-avoid">
        <h3 className="font-bold text-sm uppercase mb-3 tracking-wide text-gray-800 border-l-4 border-[#ffd75b] pl-2">Payment Schedule & Logistics</h3>
                ...
                <table className="w-full text-sm border-collapse border border-gray-200 mb-4">
                  ...
                  <tbody>
                    {data.financials.paymentMilestones.map((ms) => (
                      <tr key={ms.id} className={ms.isPaid ? 'bg-green-50' : ''}>
                        ...
                        <td className="p-2 border text-center">
                          {ms.isPaid ? (
                            <div className="flex flex-col items-center">
                              <span className="px-2 py-0.5 bg-green-200 text-green-800 text-[10px] font-bold rounded uppercase">Paid</span>
            ...
            <div className="flex flex-row gap-8">
                <div className="flex-1 space-y-4 text-sm">
                    ...
                    <div>
                        ...
                        <pre className="text-gray-700 font-sans whitespace-pre-wrap bg-gray-50 p-2 rounded border border-gray-100">{data.meta.bankDetails}</pre>
                    </div>
                </div>
      ...
      {/* TERMS */}
      <div className="p-7 border-b border-gray-100 break-inside-avoid">
        <h3 className="font-bold text-sm uppercase mb-3 tracking-wide text-gray-800 border-l-4 border-[#ffd75b] pl-2">Terms & Conditions</h3>
      ...
      <div className="p-7 break-inside-avoid">
        <h3 className="font-bold text-sm uppercase mb-6 tracking-wide text-gray-800 border-l-4 border-[#ffd75b] pl-2">Approval</h3>
      ...
      {/* FOOTER */}
      <div className="bg-[#fffef4] border-t border-gray-200 p-4 text-center text-xs text-gray-500">
